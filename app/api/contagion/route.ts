...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Send the contagion data as a question to the chat pipeline
    const response = await client.chat(token, JSON.stringify(contagionData));
    const narrative = response.answers; // The narrative generated by the LLM
